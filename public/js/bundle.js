...
},{"axios":"../../node_modules/axios/index.js"}],"mapboxModel.js":[function(require,module,exports) {
"use strict";

Object.defineProperty(exports, "__esModule", {
  value: true
});
exports.persistLocation = exports.getKeys = exports.createGeoJSON = exports.TOKEN = void 0;
...
function () {
  ...
  return function persistLocation(_x) {
    return _ref.apply(this, arguments);
  };
}();
...
function () {
  var _ref3 = _asyncToGenerator(
  /*#__PURE__*/
  _regeneratorRuntime().mark(function _callee3(waypoints) {
    ...
    return _regeneratorRuntime().wrap(function _callee3$(_context3) {
      while (1) switch (_context3.prev = _context3.next) {
        ...
        case 8:
          ...
          return _context3.abrupt("return", routeData);
  ...
  return function createGeoJSON(_x2) {
    return _ref3.apply(this, arguments);
  };
}();
...
var mapboxModel = _interopRequireWildcard(require("./mapboxModel.js"));
...
},{"./Views.js":"Views.js","./mapboxModel.js":"mapboxModel.js"}],"Views.js":[function(require,module,exports) {
"use strict";
...
var activateGeocoder = exports.activateGeocoder = function activateGeocoder() {
  ...
  document.querySelector('#geocoder').appendChild(geocoder.onAdd(_mapboxController.map));
};
...
var addHandler = function addHandler(popup, handler) {
  document.querySelector('.newLocation__popup-form').addEventListener('submit', function (e) {
    e.preventDefault();
    var coordArray = [popup._lngLat.lng, popup._lngLat.lat];
    var form = createFormData(coordArray);
    popup.remove();
    handler(form, coordArray);
  });
};

var createFormData = function createFormData(coordArray) {
  var form = new FormData();
  form.append('name', document.querySelector('.newLocation__popup-name').value); // prettier-ignore

  form.append('address', document.querySelector('.newLocation__popup-address').value); // prettier-ignore
...
var friendSearch = exports.friendSearch =
/*#__PURE__*/
function () {
  var _ref = _asyncToGenerator(
  /*#__PURE__*/
...
if (editLocationForm) editLocationForm.addEventListener('submit', function (e) {
  ...
  var coord = document.querySelector('.location-info__editCoord').value; // prettier-ignore
